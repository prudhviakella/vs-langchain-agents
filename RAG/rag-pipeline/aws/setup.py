...
def main() -> None:
    ...
    print(f"  2. bash aws/build_and_push.sh          build and push the image")
    print(f"  3. python aws/preflight.py             check quotas before spending")
    print(f"  4. python aws/sort_and_upload.py --dir ./pdfs")
    print(f"  5. python aws/run.py")
